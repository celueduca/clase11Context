...
import img from '../img/historia.jpg'
              ...
              <div className="CardPost" >
                ...
                <div className="CardDescription">
                  <div className="CardLikes">
                    <span className="CardPost--span"> 1.2k Me gusta</span>
                  </div>
                  <p>
                    <span className="CardPost--span">
                      {post.nameProfile}
                    </span>
                    {post.description}
                  </p>
