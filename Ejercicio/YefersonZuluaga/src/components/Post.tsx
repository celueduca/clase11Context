        ...
        <div>
            <div className="headerPost">
                ...
                <div className="center">
                    <img className="circular--photo" src="https://imagenes.20minutos.es/files/image_656_370/files/fp/uploads/imagenes/2021/09/29/cristiano-ronaldo.r_d.1684-405-1942.jpeg" alt="" />
                </div>
                <div>
            ...
            <div className="containerComments">
                ...
                <div className="centerComment">
                    <input className="inputModict" type="text" placeholder="Comentar"  />
                </div>
                <div className="colorPublic">
                    <p><b>Publicar</b></p>
                </div>
            </div>
        </div>
